...
; RUN: llc < %s -mtriple=aarch64-unknown | FileCheck %s --check-prefixes=CHECK-LE,CHECK-SD-LE
; RUN: llc < %s -mtriple=aarch64_be-unknown | FileCheck %s --check-prefixes=CHECK-BE,CHECK-SD-BE
; RUN: llc < %s -mtriple=aarch64-unknown -global-isel | FileCheck %s --check-prefixes=CHECK-LE,CHECK-GI-LE
; RUN: llc < %s -mtriple=aarch64_be-unknown -global-isel | FileCheck %s --check-prefixes=CHECK-BE,CHECK-GI-BE

; ptr p; // p is 4 byte aligned
; ((i32) p[0] << 24) | ((i32) p[1] << 16) | ((i32) p[2] << 8) | (i32) p[3]
define i32 @load_i32_by_i8_big_endian(ptr %arg) {
; CHECK-LE-LABEL: load_i32_by_i8_big_endian:
; CHECK-LE:       // %bb.0:
; CHECK-LE-NEXT:    ldr w8, [x0]
; CHECK-LE-NEXT:    rev w0, w8
; CHECK-LE-NEXT:    ret
;
...
; CHECK-SD-LE-LABEL: load_i32_by_i16_by_i8_big_endian:
; CHECK-SD-LE:       // %bb.0:
; CHECK-SD-LE-NEXT:    ldr w8, [x0]
; CHECK-SD-LE-NEXT:    rev w0, w8
; CHECK-SD-LE-NEXT:    ret
;
; CHECK-SD-BE-LABEL: load_i32_by_i16_by_i8_big_endian:
; CHECK-SD-BE:       // %bb.0:
; CHECK-SD-BE-NEXT:    ldr w0, [x0]
; CHECK-SD-BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: load_i32_by_i16_by_i8_big_endian:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    ldrh w8, [x0]
; CHECK-GI-LE-NEXT:    ldrb w9, [x0, #2]
; CHECK-GI-LE-NEXT:    ldrb w10, [x0, #3]
; CHECK-GI-LE-NEXT:    rev w8, w8
; CHECK-GI-LE-NEXT:    orr w9, w10, w9, lsl #8
; CHECK-GI-LE-NEXT:    lsr w8, w8, #16
; CHECK-GI-LE-NEXT:    orr w0, w9, w8, lsl #16
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: load_i32_by_i16_by_i8_big_endian:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    ldrb w8, [x0, #2]
; CHECK-GI-BE-NEXT:    ldrb w9, [x0, #3]
; CHECK-GI-BE-NEXT:    ldrh w10, [x0]
; CHECK-GI-BE-NEXT:    orr w8, w9, w8, lsl #8
; CHECK-GI-BE-NEXT:    orr w0, w8, w10, lsl #16
...
; CHECK-LE-LABEL: load_i32_by_i16:
; CHECK-LE:       // %bb.0:
; CHECK-LE-NEXT:    ldrh w8, [x0]
; CHECK-LE-NEXT:    ldrh w9, [x0, #2]
; CHECK-LE-NEXT:    orr w0, w9, w8, lsl #16
; CHECK-LE-NEXT:    ret
;
; CHECK-SD-BE-LABEL: load_i32_by_i16:
; CHECK-SD-BE:       // %bb.0:
; CHECK-SD-BE-NEXT:    ldr w0, [x0]
; CHECK-SD-BE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: load_i32_by_i16:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    ldrh w8, [x0]
; CHECK-GI-BE-NEXT:    ldrh w9, [x0, #2]
; CHECK-GI-BE-NEXT:    orr w0, w9, w8, lsl #16
; CHECK-GI-BE-NEXT:    ret
...
; CHECK-SD-LE-LABEL: load_i32_by_i16_i8:
; CHECK-SD-LE:       // %bb.0:
; CHECK-SD-LE-NEXT:    ldrh w8, [x0, #2]
; CHECK-SD-LE-NEXT:    ldrh w9, [x0]
; CHECK-SD-LE-NEXT:    rev w8, w8
; CHECK-SD-LE-NEXT:    extr w0, w9, w8, #16
; CHECK-SD-LE-NEXT:    ret
;
; CHECK-SD-BE-LABEL: load_i32_by_i16_i8:
; CHECK-SD-BE:       // %bb.0:
; CHECK-SD-BE-NEXT:    ldr w0, [x0]
; CHECK-SD-BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: load_i32_by_i16_i8:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    ldrb w8, [x0, #2]
; CHECK-GI-LE-NEXT:    ldrb w9, [x0, #3]
; CHECK-GI-LE-NEXT:    ldrh w10, [x0]
; CHECK-GI-LE-NEXT:    orr w8, w9, w8, lsl #8
; CHECK-GI-LE-NEXT:    orr w0, w8, w10, lsl #16
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: load_i32_by_i16_i8:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    ldrb w8, [x0, #2]
; CHECK-GI-BE-NEXT:    ldrb w9, [x0, #3]
; CHECK-GI-BE-NEXT:    ldrh w10, [x0]
...
; CHECK-SD-LE-LABEL: load_i64_by_i8_bswap:
; CHECK-SD-LE:       // %bb.0:
; CHECK-SD-LE-NEXT:    ldr x0, [x0]
; CHECK-SD-LE-NEXT:    ret
;
; CHECK-SD-BE-LABEL: load_i64_by_i8_bswap:
; CHECK-SD-BE:       // %bb.0:
; CHECK-SD-BE-NEXT:    ldr x8, [x0]
; CHECK-SD-BE-NEXT:    rev x0, x8
; CHECK-SD-BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: load_i64_by_i8_bswap:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    ldrb w8, [x0]
; CHECK-GI-LE-NEXT:    ldrb w9, [x0, #1]
; CHECK-GI-LE-NEXT:    orr x8, x8, x9, lsl #8
; CHECK-GI-LE-NEXT:    ldrb w9, [x0, #2]
; CHECK-GI-LE-NEXT:    orr x8, x8, x9, lsl #16
; CHECK-GI-LE-NEXT:    ldrb w9, [x0, #3]
; CHECK-GI-LE-NEXT:    orr x8, x8, x9, lsl #24
; CHECK-GI-LE-NEXT:    ldrb w9, [x0, #4]
; CHECK-GI-LE-NEXT:    orr x8, x8, x9, lsl #32
; CHECK-GI-LE-NEXT:    ldrb w9, [x0, #5]
; CHECK-GI-LE-NEXT:    orr x8, x8, x9, lsl #40
; CHECK-GI-LE-NEXT:    ldrb w9, [x0, #6]
; CHECK-GI-LE-NEXT:    orr x8, x8, x9, lsl #48
; CHECK-GI-LE-NEXT:    ldrb w9, [x0, #7]
; CHECK-GI-LE-NEXT:    orr x0, x8, x9, lsl #56
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: load_i64_by_i8_bswap:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    ldrb w8, [x0]
; CHECK-GI-BE-NEXT:    ldrb w9, [x0, #1]
; CHECK-GI-BE-NEXT:    orr x8, x8, x9, lsl #8
; CHECK-GI-BE-NEXT:    ldrb w9, [x0, #2]
; CHECK-GI-BE-NEXT:    orr x8, x8, x9, lsl #16
; CHECK-GI-BE-NEXT:    ldrb w9, [x0, #3]
; CHECK-GI-BE-NEXT:    orr x8, x8, x9, lsl #24
; CHECK-GI-BE-NEXT:    ldrb w9, [x0, #4]
; CHECK-GI-BE-NEXT:    orr x8, x8, x9, lsl #32
; CHECK-GI-BE-NEXT:    ldrb w9, [x0, #5]
; CHECK-GI-BE-NEXT:    orr x8, x8, x9, lsl #40
; CHECK-GI-BE-NEXT:    ldrb w9, [x0, #6]
; CHECK-GI-BE-NEXT:    orr x8, x8, x9, lsl #48
; CHECK-GI-BE-NEXT:    ldrb w9, [x0, #7]
; CHECK-GI-BE-NEXT:    orr x0, x8, x9, lsl #56
; CHECK-GI-BE-NEXT:    ret
...
; CHECK-SD-LE-LABEL: load_i64_by_i8:
; CHECK-SD-LE:       // %bb.0:
; CHECK-SD-LE-NEXT:    ldr x8, [x0]
; CHECK-SD-LE-NEXT:    rev x0, x8
; CHECK-SD-LE-NEXT:    ret
;
; CHECK-SD-BE-LABEL: load_i64_by_i8:
; CHECK-SD-BE:       // %bb.0:
; CHECK-SD-BE-NEXT:    ldr x0, [x0]
; CHECK-SD-BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: load_i64_by_i8:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    ldrb w8, [x0]
; CHECK-GI-LE-NEXT:    ldrb w9, [x0, #1]
; CHECK-GI-LE-NEXT:    lsl x8, x8, #56
; CHECK-GI-LE-NEXT:    orr x8, x8, x9, lsl #48
; CHECK-GI-LE-NEXT:    ldrb w9, [x0, #2]
; CHECK-GI-LE-NEXT:    orr x8, x8, x9, lsl #40
; CHECK-GI-LE-NEXT:    ldrb w9, [x0, #3]
...
; CHECK-GI-LE-NEXT:    orr x8, x8, x9, lsl #8
; CHECK-GI-LE-NEXT:    ldrb w9, [x0, #7]
; CHECK-GI-LE-NEXT:    orr x0, x8, x9
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: load_i64_by_i8:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    ldrb w8, [x0]
; CHECK-GI-BE-NEXT:    ldrb w9, [x0, #1]
; CHECK-GI-BE-NEXT:    lsl x8, x8, #56
; CHECK-GI-BE-NEXT:    orr x8, x8, x9, lsl #48
; CHECK-GI-BE-NEXT:    ldrb w9, [x0, #2]
; CHECK-GI-BE-NEXT:    orr x8, x8, x9, lsl #40
; CHECK-GI-BE-NEXT:    ldrb w9, [x0, #3]
...
; CHECK-LE-LABEL: load_i32_by_i8_nonzero_offset:
; CHECK-LE:       // %bb.0:
; CHECK-LE-NEXT:    ldur w0, [x0, #1]
; CHECK-LE-NEXT:    ret
;
...
; CHECK-LE-LABEL: load_i32_by_i8_neg_offset:
; CHECK-LE:       // %bb.0:
; CHECK-LE-NEXT:    ldur w0, [x0, #-4]
; CHECK-LE-NEXT:    ret
;
...
; CHECK-LE-LABEL: load_i32_by_i8_nonzero_offset_bswap:
; CHECK-LE:       // %bb.0:
; CHECK-LE-NEXT:    ldur w8, [x0, #1]
; CHECK-LE-NEXT:    rev w0, w8
; CHECK-LE-NEXT:    ret
;
...
; CHECK-LE-LABEL: load_i32_by_i8_neg_offset_bswap:
; CHECK-LE:       // %bb.0:
; CHECK-LE-NEXT:    ldur w8, [x0, #-4]
; CHECK-LE-NEXT:    rev w0, w8
; CHECK-LE-NEXT:    ret
;
...
; CHECK-SD-LE-LABEL: load_i32_by_bswap_i16:
; CHECK-SD-LE:       // %bb.0:
; CHECK-SD-LE-NEXT:    ldrh w8, [x0]
; CHECK-SD-LE-NEXT:    ldrh w9, [x0, #2]
; CHECK-SD-LE-NEXT:    rev16 w8, w8
; CHECK-SD-LE-NEXT:    rev16 w9, w9
; CHECK-SD-LE-NEXT:    orr w0, w8, w9, lsl #16
; CHECK-SD-LE-NEXT:    ret
;
; CHECK-SD-BE-LABEL: load_i32_by_bswap_i16:
; CHECK-SD-BE:       // %bb.0:
; CHECK-SD-BE-NEXT:    ldr w8, [x0]
; CHECK-SD-BE-NEXT:    rev w0, w8
; CHECK-SD-BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: load_i32_by_bswap_i16:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    ldrh w8, [x0, #2]
; CHECK-GI-LE-NEXT:    ldrh w9, [x0]
; CHECK-GI-LE-NEXT:    rev w8, w8
; CHECK-GI-LE-NEXT:    rev w9, w9
; CHECK-GI-LE-NEXT:    lsr w8, w8, #16
; CHECK-GI-LE-NEXT:    extr w0, w8, w9, #16
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: load_i32_by_bswap_i16:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    ldrh w8, [x0, #2]
; CHECK-GI-BE-NEXT:    ldrh w9, [x0]
; CHECK-GI-BE-NEXT:    rev w8, w8
; CHECK-GI-BE-NEXT:    rev w9, w9
; CHECK-GI-BE-NEXT:    lsr w8, w8, #16
; CHECK-GI-BE-NEXT:    extr w0, w8, w9, #16
; CHECK-GI-BE-NEXT:    ret
  %tmp1 = load i16, ptr %arg, align 4
...
; CHECK-SD-LE-LABEL: load_i32_by_sext_i16:
; CHECK-SD-LE:       // %bb.0:
; CHECK-SD-LE-NEXT:    ldrh w8, [x0]
; CHECK-SD-LE-NEXT:    ldrh w9, [x0, #2]
; CHECK-SD-LE-NEXT:    orr w0, w9, w8, lsl #16
; CHECK-SD-LE-NEXT:    ret
;
; CHECK-SD-BE-LABEL: load_i32_by_sext_i16:
; CHECK-SD-BE:       // %bb.0:
; CHECK-SD-BE-NEXT:    ldr w0, [x0]
; CHECK-SD-BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: load_i32_by_sext_i16:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    ldrsh w8, [x0]
; CHECK-GI-LE-NEXT:    ldrh w9, [x0, #2]
; CHECK-GI-LE-NEXT:    orr w0, w9, w8, lsl #16
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: load_i32_by_sext_i16:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    ldrsh w8, [x0]
; CHECK-GI-BE-NEXT:    ldrh w9, [x0, #2]
; CHECK-GI-BE-NEXT:    orr w0, w9, w8, lsl #16
; CHECK-GI-BE-NEXT:    ret
  %tmp1 = load i16, ptr %arg, align 4
...
; CHECK-SD-LE-LABEL: load_i32_by_i8_base_offset_index:
; CHECK-SD-LE:       // %bb.0:
; CHECK-SD-LE-NEXT:    add x8, x0, w1, uxtw
; CHECK-SD-LE-NEXT:    ldr w0, [x8, #12]
; CHECK-SD-LE-NEXT:    ret
;
; CHECK-SD-BE-LABEL: load_i32_by_i8_base_offset_index:
; CHECK-SD-BE:       // %bb.0:
; CHECK-SD-BE-NEXT:    add x8, x0, w1, uxtw
; CHECK-SD-BE-NEXT:    ldr w8, [x8, #12]
; CHECK-SD-BE-NEXT:    rev w0, w8
; CHECK-SD-BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: load_i32_by_i8_base_offset_index:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    mov w8, w1
; CHECK-GI-LE-NEXT:    add x9, x0, #12
; CHECK-GI-LE-NEXT:    add x10, x9, x8
; CHECK-GI-LE-NEXT:    ldrb w8, [x9, x8]
; CHECK-GI-LE-NEXT:    ldrb w9, [x10, #1]
; CHECK-GI-LE-NEXT:    orr w8, w8, w9, lsl #8
; CHECK-GI-LE-NEXT:    ldrb w9, [x10, #2]
; CHECK-GI-LE-NEXT:    orr w8, w8, w9, lsl #16
; CHECK-GI-LE-NEXT:    ldrb w9, [x10, #3]
; CHECK-GI-LE-NEXT:    orr w0, w8, w9, lsl #24
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: load_i32_by_i8_base_offset_index:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    mov w8, w1
; CHECK-GI-BE-NEXT:    add x9, x0, #12
; CHECK-GI-BE-NEXT:    add x10, x9, x8
; CHECK-GI-BE-NEXT:    ldrb w8, [x9, x8]
; CHECK-GI-BE-NEXT:    ldrb w9, [x10, #1]
; CHECK-GI-BE-NEXT:    orr w8, w8, w9, lsl #8
; CHECK-GI-BE-NEXT:    ldrb w9, [x10, #2]
; CHECK-GI-BE-NEXT:    orr w8, w8, w9, lsl #16
; CHECK-GI-BE-NEXT:    ldrb w9, [x10, #3]
; CHECK-GI-BE-NEXT:    orr w0, w8, w9, lsl #24
; CHECK-GI-BE-NEXT:    ret
...
; CHECK-LE-LABEL: load_i32_by_i8_base_offset_index_2:
; CHECK-LE:       // %bb.0:
; CHECK-LE-NEXT:    add x8, x0, w1, uxtw
; CHECK-LE-NEXT:    ldur w0, [x8, #13]
; CHECK-LE-NEXT:    ret
;
...
; CHECK-SD-LE-LABEL: zext_load_i32_by_i8:
; CHECK-SD-LE:       // %bb.0:
; CHECK-SD-LE-NEXT:    ldrh w0, [x0]
; CHECK-SD-LE-NEXT:    ret
;
; CHECK-SD-BE-LABEL: zext_load_i32_by_i8:
; CHECK-SD-BE:       // %bb.0:
; CHECK-SD-BE-NEXT:    ldrh w8, [x0]
; CHECK-SD-BE-NEXT:    rev16 w0, w8
; CHECK-SD-BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: zext_load_i32_by_i8:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    ldrb w8, [x0]
; CHECK-GI-LE-NEXT:    ldrb w9, [x0, #1]
; CHECK-GI-LE-NEXT:    orr w0, w8, w9, lsl #8
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: zext_load_i32_by_i8:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    ldrb w8, [x0]
; CHECK-GI-BE-NEXT:    ldrb w9, [x0, #1]
; CHECK-GI-BE-NEXT:    orr w0, w8, w9, lsl #8
; CHECK-GI-BE-NEXT:    ret
...
; CHECK-LE-LABEL: zext_load_i32_by_i8_shl_8:
; CHECK-LE:       // %bb.0:
; CHECK-LE-NEXT:    ldrb w8, [x0]
; CHECK-LE-NEXT:    ldrb w9, [x0, #1]
; CHECK-LE-NEXT:    lsl w8, w8, #8
; CHECK-LE-NEXT:    orr w0, w8, w9, lsl #16
; CHECK-LE-NEXT:    ret
;
...
; CHECK-LE-LABEL: zext_load_i32_by_i8_shl_16:
; CHECK-LE:       // %bb.0:
; CHECK-LE-NEXT:    ldrb w8, [x0]
; CHECK-LE-NEXT:    ldrb w9, [x0, #1]
; CHECK-LE-NEXT:    lsl w8, w8, #16
; CHECK-LE-NEXT:    orr w0, w8, w9, lsl #24
; CHECK-LE-NEXT:    ret
;
...
; CHECK-SD-LE-LABEL: zext_load_i32_by_i8_bswap:
; CHECK-SD-LE:       // %bb.0:
; CHECK-SD-LE-NEXT:    ldrh w8, [x0]
; CHECK-SD-LE-NEXT:    rev16 w0, w8
; CHECK-SD-LE-NEXT:    ret
;
; CHECK-SD-BE-LABEL: zext_load_i32_by_i8_bswap:
; CHECK-SD-BE:       // %bb.0:
; CHECK-SD-BE-NEXT:    ldrh w0, [x0]
; CHECK-SD-BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: zext_load_i32_by_i8_bswap:
; CHECK-GI-LE:       // %bb.0:
...
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: zext_load_i32_by_i8_bswap:
; CHECK-GI-BE:       // %bb.0:
...
; CHECK-LE-LABEL: zext_load_i32_by_i8_bswap_shl_8:
; CHECK-LE:       // %bb.0:
; CHECK-LE-NEXT:    ldrb w8, [x0, #1]
; CHECK-LE-NEXT:    ldrb w9, [x0]
; CHECK-LE-NEXT:    lsl w8, w8, #8
; CHECK-LE-NEXT:    orr w0, w8, w9, lsl #16
; CHECK-LE-NEXT:    ret
;
...
; CHECK-LE-LABEL: zext_load_i32_by_i8_bswap_shl_16:
; CHECK-LE:       // %bb.0:
; CHECK-LE-NEXT:    ldrb w8, [x0, #1]
; CHECK-LE-NEXT:    ldrb w9, [x0]
; CHECK-LE-NEXT:    lsl w8, w8, #16
...
; CHECK-LE-LABEL: load_i16_from_nonzero_offset:
; CHECK-LE:       // %bb.0:
; CHECK-LE-NEXT:    ldrh w8, [x0]
; CHECK-LE-NEXT:    ldrb w9, [x0, #2]
; CHECK-LE-NEXT:    orr w0, w9, w8, lsl #8
; CHECK-LE-NEXT:    ret
;

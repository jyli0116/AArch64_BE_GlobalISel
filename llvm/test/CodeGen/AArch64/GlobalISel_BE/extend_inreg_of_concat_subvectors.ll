...
; RUN: llc -mtriple=arm64-apple-ios -global-isel -mattr=+sve -o - %s | FileCheck %s --check-prefixes=CHECK-LE,CHECK-GI-LE
; RUN: llc -mtriple=aarch64_be-unknown-linux -global-isel -mattr=+sve -o - %s | FileCheck %s --check-prefixes=CHECK-BE,CHECK-GI-BE
